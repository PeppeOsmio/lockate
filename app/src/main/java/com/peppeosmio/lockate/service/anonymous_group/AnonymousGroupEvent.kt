...
sealed class AnonymousGroupEvent {
    ...
    data class SendDisabledEvent(val anonymousGroupId: String): AnonymousGroupEvent()
    data class SendEnabledEvent(val anonymousGroupId: String): AnonymousGroupEvent()
